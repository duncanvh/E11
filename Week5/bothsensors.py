...
while T < runtime:
    ...
    writer.writerow([realtime, aqdata['pm10 standard'], aqdata["pm25 standard"], aqdata["pm100 standard"], bme680.temperature, bme680.gas, bme680.relative_humidity, bme680.pressure, bme680.altitude])
